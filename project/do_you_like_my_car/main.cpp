...
// Captures debug information from DoYouLikeMyCar as lines (polygon fill and color is discarded)
class DoYouLikeMyCarDebugDraw : public b2Draw
{
public:
  DoYouLikeMyCarDebugDraw()
  {
...
public:
  ...
  void spawnWall(int x, int y, int width, int height)
  {
...
private:
  ...
  SDLRenderer r;
  Camera camera;
  DoYouLikeMyCarDebugDraw debugDraw;
  Player player;
  bool spawn = false;
};
...
int main()
{
  std::cout << "Do you like... my car? (my car)" << std::endl;
  new DoYouLikeMyCar();
